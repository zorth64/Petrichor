...
class NowPlayingManager {
    ...
    func connectRemoteCommandCenter(audioPlayer: AudioPlayerManager, playlistManager: PlaylistManager) {
        ...
        commandCenter.playCommand.addTarget { [weak audioPlayer] event in
        ...
        commandCenter.pauseCommand.addTarget { [weak audioPlayer] event in
        ...
        commandCenter.togglePlayPauseCommand.addTarget { [weak audioPlayer] event in
            guard let audioPlayer = audioPlayer else { return .commandFailed }
        ...
        commandCenter.nextTrackCommand.addTarget { [weak playlistManager] event in
        ...
        commandCenter.previousTrackCommand.addTarget { [weak playlistManager] event in
            guard let playlistManager = playlistManager else { return .commandFailed }
